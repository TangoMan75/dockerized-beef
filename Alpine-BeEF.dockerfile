#/**
# * TangoMan Alpine-BeEF.dockerfile
# *
# * @version  0.1.0
...
RUN apk update \
    && apk add autoconf automake bison build-base curl git libc6-compat libressl-dev libtool libxml2-dev libxslt-dev ncurses5 nodejs openssl readline-dev sqlite sqlite-dev yaml-dev zlib zlib-dev \
